                    ...
                    <table class="table">
                        ...
                        <?php $k=1; for ($i = 0; $i < count($my_courses); ++$i) {?>
                            <tr>
                                ...
                                <td><?php echo '<a href="'.base_url().'instructor_home/feedback_summery_teacher_wise/'.$username.'/'.$my_courses[$i]->course_id.'/'.$my_courses[$i]->semester_id.'"> '.$my_courses[$i]->full_name.' ('.$my_courses[$i]->teacher_id.') ('.$my_courses[$i]->instructor_given.')'.'</a>' ?></td>
                                <td>
